...
# Adding first graph - plot 2
with(date_tab, plot(CombinedDate, as.numeric(Global_active_power), type = "l", xlab = "", ylab = "Global Active Power (kilowatts)"))

# Adding second graph
with(date_tab, plot(CombinedDate, as.numeric(Voltage), type = "l", xlab = "datetime", ylab = "Voltage"))
...
# Adding fourth graph
with(date_tab, plot(CombinedDate, as.numeric(Global_reactive_power), type = "l", xlab = "datetime", ylab = "Global_reactive_power"))
